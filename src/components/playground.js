...
//     <animated.div className="image" {...bind()} key={i} style={{ display, transform: x.interpolate(x => `translate3d(${x}px,0,0)`) }}>
//       <animated.div style={{ transform: sc.interpolate(s => `scale(${s})`), backgroundImage: `url(${pages[i]})`, width:"100vw", height:"80vh", position:"absolute" }} />
//     </animated.div>
//   ))
// }
...
//   return (
//     <animated.div>
//       {o.interpolate(n => n.toFixed(0)) /* innerText interpolation ... */}
//     </animated.div>
//   )
// }
...
//       await next({ opacity: 1, color: '#ffaaee', config: {duration: 300} })
...
//       <div style={{ height: '700%', overflow: 'hidden' }}>{"HELLO MY FRIEND. WHAT ARE YOU LOOKING AT?"}</div>
//       <animated.svg style={{ transform: interpBg }} viewBox="0 0 490 512">
//         <g id="bg">
...
//         </g>
//         <animated.g id="face" transform={interpFace}>
...
//           </animated.g>
//         </animated.g>
//         <animated.g id="mouth" transform={interpMouth}>
...
//         </animated.g>
//         <animated.g id="hair" transform={interpHair}>
